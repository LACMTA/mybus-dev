...
function loadFrequencyTable(data) {
    ...
    for (let i = 0; i < data.length; i++) {
        ...
        weekday_peak = document.createElement('td');
        weekday_peak.innerHTML = data[i]["weekday-peak"];
        weekday_mid = document.createElement('td');
        weekday_mid.innerHTML = data[i]["weekday-midday"];
        weekday_evening = document.createElement('td');
        ...
        saturdays_daytime = document.createElement('td');
        saturdays_daytime.innerHTML = data[i]["saturday-daytime"];
        saturdays_evening = document.createElement('td');
        saturdays_evening.innerHTML = data[i]["saturday-evening"];
        sundays_daytime = document.createElement('td');
        sundays_daytime.innerHTML = data[i]["sunday-daytime"];
        sundays_evening = document.createElement('td');
